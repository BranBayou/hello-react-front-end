...
**[Hello-react-front-end]** Hello-react-front-end app uses rails app end point to show random greetings.
...
- `git clone ggit@github.com:BranBayou/hello-react-front-end.git`
...
Feel free to check the [issues page](hhttps://github.com/BranBayou/hello-react-front-end/issues).
